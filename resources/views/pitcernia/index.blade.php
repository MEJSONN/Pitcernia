...
@section('content')
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        @foreach ($data as $item)
            ...
            <div class="col">
                <div class="card h-100 shadow">
                    <img src="{{ asset('images/' . $itemId . '.jpeg') }}" class="card-img-top cursor-pointer"
                        data-bs-toggle="modal" data-bs-target="#Pizza_{{ $itemId }}" style="object-fit: cover; height: 250px;"
                        alt="{{ $itemId }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mt-3">
                            <button class="btn btn-outline-secondary btn-lg w-100 shadow add-to-cart-btn"
                                data-id="{{ $itemId }}" data-name="{{ $item->name }}" data-price="{{ $item->price }}"
            ...
            <div class="modal fade shadow" id="Pizza_{{ $itemId }}" tabindex="-1" aria-labelledby="Pizza_{{ $itemId }}"
                aria-hidden="true">
