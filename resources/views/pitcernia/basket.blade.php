            ...
            <div class="border rounded p-3 bg-light shadow-sm mb-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-5 d-flex align-items-center gap-3 mb-2 mb-md-0">
                        <img src="{{ asset('images/' . $id . '.jpeg') }}" style="width: 80px" class="rounded">
                        <div>
                    ...
                    <!-- Ilość -->
                    <div class="col-6 col-md-3 d-flex justify-content-center my-2 my-md-0">
                    ...
                    <!-- Cena i Usuń -->
                    <div class="col-6 col-md-4 d-flex justify-content-between justify-content-md-end align-items-center gap-2">
