...
@section('content')
    ...
    <div
        ...
        <div class="w-100 mt-3 collapse" id="filter-form">
            <form class="d-flex flex-column w-100" method="GET" id="filter-form">
                ...
                <div class="d-flex flex-column gap-3 mb-2 w-100">
                    <div class="row mb-2">
                        ...
                        <div class="d-flex gap-3">
                            <div class="mb-3 w-50">
                                <input type="number" class="form-control" name="min_price" id="min_price" aria-describedby="minPriceHelp" placeholder="Od..." />
                                <small id="minPriceHelp" class="form-text text-muted">Cena minimalna</small>
                            </div>

                            <div class="mb-3 w-50">
                                <input type="number" class="form-control" name="max_price" id="max_price" aria-describedby="maxPriceHelp" placeholder="Do..." />
        ...
        @foreach ($data as $item)
            ...
            <div class="col">
                <div class="card h-100 cursor-pointer shadow" data-bs-toggle="modal"
                    ...
                    <img src="https://picsum.photos/300/200" class="card-img-top" alt="Pizza">
                    <div class="card-body">
                    ...
                    <div class="modal-content shadow-sm rounded-3 border-0">
                        ...
                        <div class="modal-body p-4 shadow">
                            <div class="text-center mb-3">
                                <img src="https://picsum.photos/500/300?random" class="img-fluid rounded-3 shadow"
                                    alt="{{ $item->name }}">
                            </div>
                            <div
